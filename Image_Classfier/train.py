...
if __name__ == '__main__':
    ...
    # Model learning rate '--learning_rate' argument, else 0.01
    if "--learning_rate" in args:
        learning_rate = args[args.index("--learning_rate") + 1]
    else:
        learning_rate = 0.01

    # Network hidden layers '--hidden_units' argument, else [512]
    ...
    # Number of training epochs '--epochs' argument, else 20
    if "--epochs" in args:
